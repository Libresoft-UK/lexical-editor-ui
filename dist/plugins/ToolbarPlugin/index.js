...
export default function ToolbarPlugin({ editor, activeEditor, setActiveEditor, setIsLinkEditMode, }) {
    ...
    return (_jsxs("div", { className: "flex flex-row h-12 gap-2 p-1 overflow-auto", children: [_jsx("button", { disabled: !toolbarState.canUndo || !isEditable, onClick: () => {
                ...
                }, className: buttonClassName + ' ' + (toolbarState.isLowercase ? activeButtonClassName : ''), title: `Lowercase (${SHORTCUTS.LOWERCASE})`, "aria-label": "Format text to lowercase", children: _jsx(Alphabet, { size: 24, className: 'py-0.5 w-6' }) }), _jsx("button", { onClick: () => {
                    activeEditor.dispatchCommand(FORMAT_TEXT_COMMAND, 'uppercase');
                }, className: buttonClassName + ' ' + (toolbarState.isUppercase ? activeButtonClassName : ''), title: `Uppercase (${SHORTCUTS.UPPERCASE})`, "aria-label": "Format text to uppercase", children: _jsx(AlphabetUppercase, { size: 24, className: 'py-0.5 w-6' }) }), _jsx("button", { onClick: () => {
                    activeEditor.dispatchCommand(FORMAT_TEXT_COMMAND, 'capitalize');
                }, className: buttonClassName + ' ' + (toolbarState.isCapitalize ? activeButtonClassName : ''), title: `Capitalize (${SHORTCUTS.CAPITALIZE})`, "aria-label": "Format text to capitalize", children: _jsx(Type, { size: 24 }) }), _jsx("button", { onClick: () => {
                    activeEditor.dispatchCommand(FORMAT_TEXT_COMMAND, 'subscript');
                }, className: buttonClassName + ' ' + (toolbarState.isSubscript ? activeButtonClassName : ''), title: `Subscript (${SHORTCUTS.SUBSCRIPT})`, "aria-label": "Format text with a subscript", children: _jsx(Subscript, { size: 24 }) }), _jsx("button", { onClick: () => {
                    activeEditor.dispatchCommand(FORMAT_TEXT_COMMAND, 'superscript');
                }, className: buttonClassName + ' ' + (toolbarState.isSuperscript ? activeButtonClassName : ''), title: `Superscript (${SHORTCUTS.SUPERSCRIPT})`, "aria-label": "Format text with a superscript", children: _jsx(Superscript, { size: 24 }) }), _jsx("button", { className: buttonClassName + ' ' + (toolbarState.blockType === 'bullet' ? activeButtonClassName : ''), onClick: () => formatBulletList(editor, toolbarState.blockType), title: `Bullet List (${SHORTCUTS.BULLET_LIST})`, "aria-label": `Format text as bullet list. Shortcut: ${SHORTCUTS.BULLET_LIST}`, children: _jsx(ListTask, { size: 24 }) }), _jsx("button", { className: buttonClassName + ' ' + (toolbarState.blockType === 'number' ? activeButtonClassName : ''), onClick: () => formatNumberedList(editor, toolbarState.blockType), title: `Numbered List (${SHORTCUTS.NUMBERED_LIST})`, "aria-label": `Format text as numbered list. Shortcut: ${SHORTCUTS.NUMBERED_LIST}`, children: _jsx(ListOl, { size: 24 }) }), _jsx("button", { onClick: () => clearFormatting(activeEditor), className: buttonClassName, title: `Clear text formatting (${SHORTCUTS.CLEAR_FORMATTING})`, "aria-label": "Clear all text formatting", children: _jsx(Eraser, { size: 24 }) }), canViewerSeeInsertDropdown && (_jsxs(_Fragment, { children: [_jsx(Divider, {}), _jsxs(DropDown, { disabled: !isEditable, buttonClassName: "toolbar-item spaced", buttonLabel: "Insert", buttonAriaLabel: "Insert specialized editor node", buttonIconClassName: "icon plus", children: [_jsx(DropDownItem, { onClick: () => {
                                    activeEditor.dispatchCommand(INSERT_HORIZONTAL_RULE_COMMAND, undefined);
                                }, className: "item", icon: _jsx(FileBreak, { size: 20 }), children: _jsx("span", { className: "text", children: "Horizontal Rule" }) }), _jsx(DropDownItem, { onClick: () => {
                                ...
                                }, className: "item", icon: _jsx(Image, { size: 20 }), children: _jsx("span", { className: "text", children: "Image" }) })] })] })), _jsx(Divider, {}), _jsx(ElementFormatDropdown, { disabled: !isEditable, value: toolbarState.elementFormat, editor: activeEditor, isRTL: toolbarState.isRTL }), modal] }));
}
