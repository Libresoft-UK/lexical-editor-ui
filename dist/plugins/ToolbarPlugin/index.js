...
import { Alphabet, AlphabetUppercase, ArrowClockwise, ArrowCounterclockwise, Eraser, Justify, ListOl, ListTask, PaintBucket, Quote, Subscript, Superscript, TextCenter, TextIndentLeft, TextIndentRight, TextLeft, TextParagraph, TextRight, Type, TypeBold, TypeH1, TypeH2, TypeH3, TypeItalic, TypeStrikethrough, TypeUnderline } from "react-bootstrap-icons";
...
export default function ToolbarPlugin({ editor, activeEditor, setActiveEditor, setIsLinkEditMode, }) {
    ...
    return (_jsxs("div", { className: "flex flex-row h-10 gap-2 p-1", children: [_jsx("button", { disabled: !toolbarState.canUndo || !isEditable, onClick: () => {
                ...
                }, title: IS_APPLE ? 'Redo (⇧⌘Z)' : 'Redo (Ctrl+Y)', type: "button", className: buttonClassName, "aria-label": "Redo", children: _jsx(ArrowClockwise, { size: 24 }) }), _jsx(Divider, {}), toolbarState.blockType in blockTypeToBlockName &&
                ...
                }, className: buttonClassName + ' ' + (toolbarState.isLowercase ? activeButtonClassName : ''), title: "Lowercase", "aria-label": "Format text to lowercase", children: _jsx(Alphabet, { size: 24, className: 'py-0.5 w-6' }) }), _jsx("button", { onClick: () => {
                    activeEditor.dispatchCommand(FORMAT_TEXT_COMMAND, 'uppercase');
                }, className: buttonClassName + ' ' + (toolbarState.isUppercase ? activeButtonClassName : ''), title: "Uppercase", "aria-label": "Format text to uppercase", children: _jsx(AlphabetUppercase, { size: 24, className: 'py-0.5 w-6' }) }), _jsx("button", { onClick: () => {
                    activeEditor.dispatchCommand(FORMAT_TEXT_COMMAND, 'capitalize');
                }, className: buttonClassName + ' ' + (toolbarState.isCapitalize ? activeButtonClassName : ''), title: "Capitalize", "aria-label": "Format text to capitalize", children: _jsx(Type, { size: 24 }) }), _jsx("button", { onClick: () => {
                    activeEditor.dispatchCommand(FORMAT_TEXT_COMMAND, 'subscript');
                }, className: buttonClassName + ' ' + (toolbarState.isSubscript ? activeButtonClassName : ''), title: "Subscript", "aria-label": "Format text with a subscript", children: _jsx(Subscript, { size: 24 }) }), _jsx("button", { onClick: () => {
                    activeEditor.dispatchCommand(FORMAT_TEXT_COMMAND, 'superscript');
                }, className: buttonClassName + ' ' + (toolbarState.isSuperscript ? activeButtonClassName : ''), title: "Superscript", "aria-label": "Format text with a superscript", children: _jsx(Superscript, { size: 24 }) }), _jsx("button", { className: buttonClassName + ' ' + (toolbarState.blockType === 'bullet' ? activeButtonClassName : ''), onClick: () => formatBulletList(editor, toolbarState.blockType), title: `Bullet List (${SHORTCUTS.BULLET_LIST})`, "aria-label": `Format text as bullet list. Shortcut: ${SHORTCUTS.BULLET_LIST}`, children: _jsx(ListTask, { size: 24 }) }), _jsx("button", { className: buttonClassName + ' ' + (toolbarState.blockType === 'number' ? activeButtonClassName : ''), onClick: () => formatNumberedList(editor, toolbarState.blockType), title: `Numbered List (${SHORTCUTS.NUMBERED_LIST})`, "aria-label": `Format text as numbered list. Shortcut: ${SHORTCUTS.NUMBERED_LIST}`, children: _jsx(ListOl, { size: 24 }) }), _jsx("button", { onClick: () => clearFormatting(activeEditor), className: buttonClassName, title: "Clear text formatting", "aria-label": "Clear all text formatting", children: _jsx(Eraser, { size: 24 }) }), canViewerSeeInsertDropdown && (_jsxs(_Fragment, { children: [_jsx(Divider, {}), _jsxs(DropDown, { disabled: !isEditable, buttonClassName: "toolbar-item spaced", buttonLabel: "Insert", buttonAriaLabel: "Insert specialized editor node", buttonIconClassName: "icon plus", children: [_jsxs(DropDownItem, { onClick: () => {
